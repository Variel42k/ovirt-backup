...
Файловый движок включается feature gate и не смешивается с заданиями ВМ.
Администратор задаёт абсолютные source/restore roots в YAML, а web/API оперируют
только ID корня и относительными include/exclude. Сканер не следует по symlink,
