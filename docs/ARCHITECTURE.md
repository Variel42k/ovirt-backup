...
| Задания ВМ, Engine и файлов | cron из базы в системной IANA-зоне | `scheduler` |
...
- **Application hooks.** `fsfreeze` даёт filesystem-consistent точку, но
  `pre-freeze`/`post-thaw`/`post-backup` для баз данных ещё не реализованы.
