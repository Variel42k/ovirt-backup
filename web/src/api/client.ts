...
export const api = {
  ...
  setRuntimeTimezone: (timezone: string) =>
    http.put<RuntimeSettings>('/settings/runtime/timezone', { timezone }).then((r) => r.data),
  resetRuntimeTimezone: () =>
    http.delete<RuntimeSettings>('/settings/runtime/timezone').then((r) => r.data),
