...
Новое задание в интерфейсе, разовый бэкап со страницы ВМ и готовые
расписания создаются с уровнем `crash`: горячий бэкап идёт без паузы записи.
Заморозку администратор включает сам — подробнее в
[HOT-BACKUP.md](HOT-BACKUP.md#7-заморозка).
